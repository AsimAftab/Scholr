        ...
        <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden mt-6">
          ...
          <div className="p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white">
            <div className="flex items-center gap-3">
               <div className="w-10 h-10 bg-blue-50 rounded-xl flex flex-shrink-0 items-center justify-center">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-4 py-2.5 rounded-lg bg-blue-500 text-white text-sm font-semibold shadow-sm transition-all hover:bg-blue-600 active:scale-95"
              >
                Edit Profile
              </button>
              <button
                onClick={() => setIsPasswordModalOpen(true)}
                className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-white border border-zinc-200 text-zinc-900 text-sm font-semibold shadow-sm transition-all hover:bg-zinc-50 active:scale-95"
              >
