    ...
    >
      ...
      {activeTab === "history" && (
        <div className="animate-in fade-in duration-300 space-y-6">
          ...
          <div id="profile-education-section" className="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden">
      ...
      {/* Documents Tab */}
      {activeTab === "documents" && (
        <div id="profile-documents-section" className="animate-in fade-in duration-300 space-y-6">
          {/* Resume Card */}
          ...
          <div id="profile-work-section" className="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden">
            <div className="p-6 md:p-8 flex items-center justify-between bg-zinc-50/50 border-b border-zinc-100">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-zinc-100 rounded-xl flex items-center justify-center shrink-0">
                  <HiOutlineDocumentCheck className="w-5 h-5 text-zinc-950" />
